	...
	<nav class="navbar navbar-default">
	        <div class="container">
	          <div class="navbar-header">
	            ...
	            <a class="navbar-brand" href="#">Project; Alliance</a>
	          </div>
	            ...
	            <ul class="nav navbar-nav">
	              ...
	              <li class="dropdown">
	                ...
	                <ul class="dropdown-menu">
	                  <li><a href="#">Course Objective and Outline</a></li>
	              ...
	              <li class="dropdown">
	                ...
	                <ul class="dropdown-menu">
	              	  <li><a href="#">Pre-Training Skills Analysis</a></li>
	                  <li><a href="#">Training Needs Analysis</a></li>
	                </ul>
	              </li>
	              <li class="dropdown">
	                ...
	                <ul class="dropdown-menu">
	                  ...
	                  <li><a href="#">Facilitator's Feedback</a></li>
	                  <li><a href="#">Training Effectiveness Assesment</a></li>
	                </ul>
	              </li>
	              </ul>
